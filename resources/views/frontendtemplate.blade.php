...
<head>
	...
	<link href="{{asset('frontend_template/css/blog-home.css')}}" rel="stylesheet">
	<link href="{{asset('frontend_template/css/blog-post.css')}}" rel="stylesheet">
	{{-- CSS --}}
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="{{route('homepage')}}">Fairy Princess's Blog</a>
